          ...
          <div className={styles.contact_links}>
            <Grid container spacing={3}>
              <Grid className={styles.my_grid} item xs={4} sm={3}>
                <a href="mailto: alawiyeolukayode@gmail.com" target='_blank'> <img src={mail} alt="" /></a>
...
<a href="https://github.com/oluseyi-frontend?tab=repositories" target='_blank'>   <img src={github} alt="" /></a>
              ...
              <Grid className={styles.my_grid} item xs={4} sm={3}>
                ...
                <a href="https://www.facebook.com/alawiye.kayode" target='_blank'> <img src={fb} alt="" /></a>


              </Grid>
              <Grid className={styles.my_grid} item xs={4} sm={3}>

                <a href="https://www.twitter.com/_oluseyi__" target='_blank'>  <img src={twitter} alt="" /></a>

              </Grid>
              <Grid className={styles.my_grid} item xs={4} sm={3}>

                <a href="https://api.whatsapp.com/send?phone=+2348114426271" target='_blank'>  <img src={whatsapp} alt="" /></a>
              </Grid>
            </Grid>
